...
/// [out] mat 回転行列
// ------------------------------------------------------
Mat4.rotate = function(axis) {

    var mat = Mat4.rotateX(axis.x);
    mat = Mat4.multiply(mat, Mat4.rotateY(axis.y));
    mat = Mat4.multiply(mat, Mat4.rotateZ(axis.z));
...
// ------------------------------------------------------
/// スケール行列を返す関数
/// [in] scale 拡大率（Vec3オブジェクトかnumberオブジェクト）
/// [out] mat スケーリング後の行列
// ------------------------------------------------------
